...
def simulate_multiple_shocks(
    ...
    """
    scenario_results = {}
    daily_growth_rate = (1 + annualized_return) ** (1 / 252) - 1  # Daily growth rate from annualized return

    print(f"SHOCK Type of shock_scenarios: {type(shock_scenarios)}, shock_scenarios: {shock_scenarios}")
    for scenario in shock_scenarios:
        ...
        projected_portfolio_values = pd.Series(portfolio_values)        # Generate projected returns
