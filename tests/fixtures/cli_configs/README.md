...
```
./pa examples/port/port-1.toml --config tests/fixtures/cli_configs/output_csv-output_snapshot-show_plot.toml --allow-stale
```

Real, documented user configs live in `examples/config/` (`example_config.toml`,
